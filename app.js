  ...
  const projects = [
    {
      ...
      tech: ["Java", "Python", "DSA", "Problem Solving"],
      description: "Actively learning and practicing Java and Python programming with a focus on data structures, algorithms, and professional coding standards.",
      github: "https://github.com/seshathri044/java-program",
      github2: "https://github.com/seshathri044/python-program",
      highlights: ["Java Programming", "Python Development", "DSA Practice"]
    },
    {
  ...
  return React.createElement('div', { className: "min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white" },
    ...
    React.createElement('section', { 
      ...
      React.createElement('div', { className: "max-w-7xl mx-auto text-center" },
        React.createElement('div', { className: "mb-6 inline-block" },
          React.createElement('div', { 
          ...
          projects.map((project, index) =>
            React.createElement('div', { 
              ...
              React.createElement('div', { className: "flex flex-wrap gap-4" },
                project.github2 ? 
                  React.createElement('div', { className: "flex flex-wrap gap-4 w-full" },
                    React.createElement('a', { 
                      href: project.github,
                      target: "_blank",
                      rel: "noopener noreferrer",
    ...
    React.createElement('section', { id: "achievements", className: "py-20 px-4 bg-slate-900/50" },
      React.createElement('div', { className: "max-w-7xl mx-auto" },
        ...
        React.createElement('div', { className: "h-1 w-32 bg-gradient-to-r from-cyan-400 to-blue-500 mx-auto mb-12 rounded-full" }),
